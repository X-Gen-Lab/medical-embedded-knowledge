...
**评估方式**: 完成架构设计练习，能够设计分层架构和定义清晰的接口
**要求分数**: 85分
...
**评估方式**: 完成端到端架构设计案例，展示从需求到实现的全流程架构能力
**要求分数**: 90分
...
- [软件架构实践（第3版）](https://example.com/software-architecture-book)
- [医疗器械软件开发：IEC 62304实践指南](https://example.com/iec62304-guide)
- [嵌入式系统架构设计](https://example.com/embedded-architecture)

### 🎓 在线课程

- [软件架构师认证课程](https://example.com/architect-certification)

### 📋 标准文档

- [IEC 62304:2006+AMD1:2015](https://www.iec.ch/standards)

### 🔧 工具

- [Enterprise Architect建模工具](https://sparxsystems.com/)
